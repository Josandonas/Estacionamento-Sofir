...
import api from '../../api';
import { validarPlacaBrasileira } from '../../utils/validations';

const CarrosCreateModal = ({ onClose, onCreate }: { onClose: () => void; onCreate: () => void }) => {
    ...
    const handlePlacaChange = (value: string) => {
        ...
        const ehValida = validarPlacaBrasileira(value); // Validação isolada
        setPlacaValida(ehValida);
        setPlacaInternacional(!ehValida); // Permite selecionar "placa internacional" se inválida
    };
    ...
    const handleCreate = async () => {
        ...
        try {
            await api.post('/carros', { modelo, placa, cliente_id: clienteId });
            onCreate();
            onClose();
        } catch (error) {
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Criar Carro</h5>
                        <button
                            type="button"
...
export default CarrosCreateModal;